...
class MeshCoreConnector extends ChangeNotifier {
  ...
  bool _addChannelMessage(int channelIndex, ChannelMessage message) {
    ...
    // The wire prefix identifies only the addressee. Never guess a target
    // message from the most recent local message by that sender: companions can
    // have different or incomplete channel histories.
    final processedMessage = message.withParsedReplyMention();
